...
$sql = "INSERT INTO `pgpreference`(`dept`, `year`, `semester`, `staffid`, `experience`, `subject1`, `subject2`, `subject3`, `lab`, `status`) VALUES ('$deptname','$selectyear','$selectsemeter','$staffid','$experience','$subject1','$subject2','$subject3','$lab','$status')";
$result = $conn->query($sql);
  
if($result){
    $_SESSION['message']['success'] = "<center><h6 style='color:green'>Add New Class.!</h6><center>";
        header("Location: ../view_pgpreference.php?myid=$staffid");
}
?>