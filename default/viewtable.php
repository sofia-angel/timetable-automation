                                                ...
                                                <div class="card-block">
                                                    <div class="dt-responsive table-responsive">
                                                        <table id="order-table" class="table table-striped table-bordered nowrap">
                                                            ...
                                                            <?php
                                                                ...
                                                                $sql = "SELECT * FROM `ugtimetable` WHERE `status`='1' AND `dept`='UG' AND `year`='2' AND `sem`='3'  ORDER BY RAND()";
                                                    ...
                                                    <tr><td><?php 
                                                        ...
                                                        <td><?php echo $row['subject']?></td>
                                                                        ...
                                                                        <!-- echo "<tr><td></td><td>".$row['subject']."</td><td>".$row['subject']."</td><td>".$row['subject']."</td><td>".$row['subject']."</td><td>".$row['subject']."</td><td>".$row['subject']."</td></tr>"; -->
                                                               <?php $i++; }
